...
export const football9394Api={
  ...
  openNegotiation:(careerId,{playerId,feeOffer,salaryOffer=0,contractYears=3})=>footballRequest(`/api/football9394/careers/${careerId}/negotiations`,{method:'POST',body:JSON.stringify({player_id:playerId,fee_offer:feeOffer,salary_offer:salaryOffer,contract_years:contractYears})}),
  counterNegotiation:(careerId,negotiationId,{feeOffer,salaryOffer=0,contractYears=3})=>footballRequest(`/api/football9394/careers/${careerId}/negotiations/${negotiationId}`,{method:'PUT',body:JSON.stringify({fee_offer:feeOffer,salary_offer:salaryOffer,contract_years:contractYears})}),
