...
const emit = defineEmits(['save-plan','set-focus'])
...
<template>
  <section class="training-workspace">
    ...
    <article class="football-panel individual-card">
      ...
      <div class="training-table-head"><span>Jugador</span><span>Condición</span><span>Carga</span><span>Riesgo</span><span>Foco individual</span></div>
